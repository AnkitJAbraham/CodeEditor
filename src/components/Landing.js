...
const Landing = () => {
  ...
  return (
    <>
      ...
      <a
        href="https://github.com/AnkitJohnAbraham/"
      ...
      >
        ...
        >
          <title>Check out my Github profile</title>
      ...
      <div className="h-4 w-full bg-gradient-to-r from-blue-900 via-yellow-400 to-green-700"></div>
